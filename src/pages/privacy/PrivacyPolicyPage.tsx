  ...
  return (
    <div className="min-h-screen bg-black text-gray-200">
      <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <p className="mt-3 text-sm text-gray-500">Last updated: July 25, 2026</p>
        ...
        <div className="mt-10 space-y-8 text-[15px] leading-7 text-gray-300">
          ...
          <section>
            ...
            <p>
              ...
              Analytics uses cookies to collect anonymous usage data. We also use Google AdSense to
              display advertisements, which may use cookies to serve personalized ads based on your
              browsing history.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Google AdSense serves ads on our platform. Google and its partners may use cookies or
              device identifiers to serve ads based on your visits to this and other websites. You can
          ...
          <section>
            <h2 className="mb-3 text-lg font-semibold text-white">5. External Links</h2>
            <p>
              Our site links to external streaming services and trailers hosted on third-party
              platforms such as YouTube. We are not responsible for the privacy practices of these
              external sites. We encourage you to review their privacy policies.
            </p>
          </section>

          <section>
            <h2 className="mb-3 text-lg font-semibold text-white">6. Data Sharing</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 text-lg font-semibold text-white">7. Children&apos;s Privacy</h2>
            <p>
